...
public class OdemeBelgesiService : BaseService<ListOdemeBelgesiDto, SelectMakbuzHareketDto>, IScopedDependency
{
    ...
    public void CiroEdilebilecekBelgeler(string odemeTurleri)
    {
        ...
        ExcludeListItems = MakbuzHareketService.ListDataSource.Where(x => x.BelgeDurumu == BelgeDurumu.CiroEdildi ||
    ...
    public override void AddSelectedItems()
    {
        ...
        foreach (var item in SelectedItems)
        {
            ...
            item.BelgeDurumu = (MakbuzService.MakbuzTuru == MakbuzTuru.KasaIslem ||
                                MakbuzService.MakbuzTuru == MakbuzTuru.BankaIslem) && item.KendiBelgemiz ? BelgeDurumu.Odendi :
                                (MakbuzService.MakbuzTuru == MakbuzTuru.KasaIslem ||
                                MakbuzService.MakbuzTuru == MakbuzTuru.BankaIslem) && !item.KendiBelgemiz ? BelgeDurumu.TahsilEdildi : BelgeDurumu.CiroEdildi;

            item.KasaId = MakbuzService.MakbuzTuru == MakbuzTuru.KasaIslem ? MakbuzService.DataSource.KasaId : null;
            item.BankaHesapId = MakbuzService.MakbuzTuru == MakbuzTuru.BankaIslem ? MakbuzService.DataSource.BankaHesapId : null;
